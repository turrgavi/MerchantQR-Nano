...
from PyQt5.QtWidgets import QMainWindow, QLabel, QApplication, QPushButton, QLineEdit, QMessageBox, QWidget, QTabWidget, QVBoxLayout
...
class MyTableWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.pushButton5.clicked.connect(self.on_click_convert)
        self.show()
